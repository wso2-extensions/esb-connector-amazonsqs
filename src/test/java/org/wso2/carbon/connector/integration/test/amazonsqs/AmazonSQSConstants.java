...
public class AmazonSQSConstants {
     ...
     */
    public static final String URL_REMAINDER = "urlRemainder";

    /**
     * Constant for x form url.
     */
    public static final String X_FORM_URL = "xFormUrl";
     ...
     */
    public static final String URL_QUEUE_NAME = "urlQueueName";
     ...
     */
    public static final String MAX_NO_OF_MESSAGES = "maxNumberOfMessages";
    ...
    /**
     * Constant for API Variable xml ampersand.
     */
