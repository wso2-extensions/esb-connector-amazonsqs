 ...
 */
public class DeleteQueue extends AbstractConnectorOperation {
    ...
    public void execute(MessageContext messageContext, String responseVariable, Boolean overwriteBody)
        ...
        try {
            ...
            JsonObject resultJSON = Utils.generateSuccessJsonResponse(deleteQueueResponse.responseMetadata());
